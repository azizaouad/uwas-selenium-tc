Feature: use case
  ...
  Scenario: photographer should login, then he should create an event and logout
    ...
    And photographer fill the title of event as "-a-d-d-"
    ...
    And title of event as "-a-d-d-" in the location of event as "home-mode" at the date of event as "2023-06-10" is created
