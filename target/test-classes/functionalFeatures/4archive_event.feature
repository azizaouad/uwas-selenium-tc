Feature: test archive and restore event functionality
  ...
  Scenario: photographer can archive any event
    Given photographer should login with his credentials email as "mkd@outlook.fr" and password as "Aziz1996@" and create an event title as "koura"
    When photographer click on the three buttouns
    And Choose archive for the event name as "koura"
