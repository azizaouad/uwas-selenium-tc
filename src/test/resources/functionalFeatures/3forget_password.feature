Feature: test forget password functionality
  ...
  Scenario: user forget his password and receive an email to reset it
    ...
    And user write password as "Curva1994@"
    And user write confirm_password as "Curva1994@"
    Then the password is changed user can login with new password as "Curva1994@" and email as "uwas01@qa.team"
