Feature: use case
  ...
  Scenario: photographer should login, then he should create an event and logout
    ...
    And photographer fill the title of event as "-a-sd-sd-"
    And photographer fill the location of event as "homes-modes"
    ...
    And title of event as "-a-sd-sd-" in the location of event as "homes-modes" at the date of event as "2023-06-10" is created
