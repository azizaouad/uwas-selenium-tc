Feature: test the sign up functionality
  ...
  Scenario: fill in all the mandatory fields respecting the conditions of each field
    ...
    And user fill email as "azizaouadi12@gmail.com"
    ...
    Then user have an account he can login with this credentials email as "azizaouadi12@gmail.com" and password as "Aziz1996@"
