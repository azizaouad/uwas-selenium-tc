Feature: test forget password functionality
  ...
  Scenario: user forget his password and receive an email to reset it
    ...
    And user write password as "Aziz205@!!"
    And user write confirm_password as "Aziz205@!!"
    Then the password is changed user can login with new password as "Aziz205@!!" and email as "uwas@qa.team"
#  @SmokeTest
