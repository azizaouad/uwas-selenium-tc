Feature: filter test
  ...
  Scenario: photographer should choose two date the first is the start date and the second is the finish date
    ...
    And user click on all filters and should choose the start date as "2024-02-20" and the finish date as "2024-03-01"
    Then the user must find the events in the period from start date as "2024-02-20" to finish date as "2024-03-01"
  @Sanity
