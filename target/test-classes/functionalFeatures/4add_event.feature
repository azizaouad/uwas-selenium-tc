Feature: test add event functionality
  ...
  Scenario: photographer can login and add event
    ...
    And photographer should fill the title of event as "noel 12"
    ...
    Then title of event as "Noel 12" event in location of event as "paris" at the date of event as "2022-12-25" is created
  @Sanity
