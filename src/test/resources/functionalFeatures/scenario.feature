...
@Sanity
  Scenario: photographer should login, then he should create an event and logout
    ...
    And photographer fill the title of event as "tests"
    ...
    And title of event as "tests" in the location of event as "paris" at the date of event as "2023-12-21" is created
