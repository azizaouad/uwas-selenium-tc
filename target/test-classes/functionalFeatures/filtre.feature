Feature: filter test
  ...
  Scenario: photographer should choose two date the first is the start date and the second is the finish date
    ...
    When user write email as "azizaouadi12@gmail.com" and password as "Aziz1996@" and click on the button of login
    And user click on all filters and should choose the start date as "2024-02-27" and the finish date as "2024-03-01"
    Then the user must find the events in the period from start date as "2024-02-27" to finish date as "2024-03-01"
  @SmokeTest
  ...
  Scenario: photographer can filter by the status of event
    Given  user should navigate to the website uwas
    When user write email as "mkd@outlook.fr" and password as "Aziz1996@" and click on the button of login
  ...
  Scenario: client can filter the events by the consultation status ( viewed events )
    Given  user should navigate to the website uwas
    When user write email as "aziz-aouadi@outlook.fr" and password as "Aziz1996@" and click on the button of login
