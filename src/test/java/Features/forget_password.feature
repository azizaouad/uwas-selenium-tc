Feature: test forget password functionality
  ...
  Scenario: user forget his password and receive an email to reset it
    ...
    And user write password as "3Aziz1996@"
    And user write confirm_password as "3Aziz1996@"
    Then the password is changed user can login with new password as "3Aziz1996@" and email as "a.aouadi@coral-io.fr"
